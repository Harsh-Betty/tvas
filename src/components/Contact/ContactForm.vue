    ...
    <form class="needs-validation" @submit.prevent="submitForm" id="myForm">
        <div class="row g-3">
            ...
            <div class="col-12">
                ...
                <input type="text" class="form-control" id="subject" placeholder="Subject" required="true" name="subject"
                    value="">
            </div>
        ...
        <button class="w-100 btn btn-tvas btn-lg my-3" @click="closePopup" type="submit">Submit</button>
    </form>
</template>
